...
class Air:
    ...
    def get_list(self):
        ...
        # Add buttons
        button1 = tk.Button(text="Aerodynamics", borderwidth=5, fg='red',
                            font='Times 28 bold', compound="center", command=self.get_test_function)

        button2 = tk.Button(text="Flight dynamics", borderwidth=5, fg='red',
                            font='Times 28 bold', compound="center", command=self.get_test_function)

        button3 = tk.Button(text="Automation and control ", borderwidth=5, fg='red',
                            font='Times 18 bold', compound="center", command=self.get_test_function)

        button4 = tk.Button(text="Projects", borderwidth=5, fg='red',
                            font='Times 28 bold', compound="center", command=self.get_test_function)
